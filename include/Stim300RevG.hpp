#ifndef _STIM300_REV_G_HPP_
#define _STIM300_REV_G_HPP_

#include "Stim300Base.hpp"

namespace imu_stim300
{
    class Stim300RevG: public imu_stim300::Stim300Base
    {
        private:
            /** Datagram for the Stim300 Revision G **/
            struct packet
            {
                uint8_t content;
	...
	protected:
            ...
            /** Convert raw aux input to voltage according to eq. 9 in datasheet
            */
            double convertAux2Voltage(const uint8_t* buffer);
